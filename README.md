...
🎬 Démo vidéo (2 min) · 👥 Équipe : `<noms>`
</div>
---
📑 Sommaire
	Section			Section
1	Le problème		7	Couverture des exigences
2	Ce que fait Kenza		8	La darija, traitée sérieusement
3	Principe de conception		9	Tests
4	Architecture agentique		10	Observabilité et traçabilité
5	Stack technique		11	Hors périmètre
6	Démarrage rapide		12	Sécurité
---
1 · 🎯 Le problème
